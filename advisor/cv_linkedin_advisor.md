...
2. The deterministic audit — run:
   ```bash
   cd /Users/example/dev/personal/atlas && uv run atlas advise --json
   ```
3. **Claude memories** for who he is and what he's been building lately:
   `/Users/example/.claude/projects/-Users-example-dev-personal/memory/` and its `MEMORY.md`.
4. His **recent projects / work** (e.g. this Atlas repo, his Acme Corp analytics work, any AI/LLM
...
3. **LinkedIn optimization** — paste-ready text (he applies it via Claude in Chrome):
   ...
   - **Experience bullets** for his current Acme Corp role, AI-forward and quantified.
