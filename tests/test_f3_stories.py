...
def test_skill_weight_beats_bare_token_overlap():
    ...
    skill_story = {"id": 1, "title": "x", "situation": "", "task": "", "action": "",
                   "result": "", "reflection": "", "skills": ["python"]}
    token_story = {"id": 2, "title": "notes on incident and rollback and pico",
                   "situation": "incident", "task": "rollback", "action": "pico",
                   "result": "", "reflection": "", "skills": []}
...
def test_ranking_is_deterministic_and_tie_broken_by_id():
    ...
    a = {"id": 7, "title": "python work", "situation": "", "task": "", "action": "",
         "result": "", "reflection": "", "skills": ["python"]}
    b = {"id": 3, "title": "python work", "situation": "", "task": "", "action": "",
         "result": "", "reflection": "", "skills": ["python"]}
...
def test_format_story_omits_missing_sections():
    sparse = {"id": 9, "title": "Only a title", "situation": "", "task": "", "action": "",
              "result": "", "reflection": "", "skills": []}
