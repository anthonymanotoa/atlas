...
CV = {
    "basics": {
        ...
        "email": "a@example.com",
        "phone": "+593 99 400 8380",
        "location": "Remote · Buenos Aires, Argentina",
        "linkedin": "https://www.linkedin.com/in/anthony-manotoa",
        "github": "https://github.com/anthonymanotoa",
...
def test_cv_filename_is_company_aware_and_ascii_safe():
    ...
    fn = cv_filename("Anthony Manotoa", "Açme Inc.", "Señor Data Scientist", "es", "pdf")
