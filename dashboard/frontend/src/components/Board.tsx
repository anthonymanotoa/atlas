...
function JobCard({
  ...
  return (
    <div
      ...
      className={cn(
        "group mb-2 cursor-grab rounded-xl border border-border bg-card px-3 py-2.5 shadow-[var(--shadow-sm),var(--highlight-top)] transition-[transform,box-shadow,border-color] duration-[120ms] ease-[var(--ease-out)] select-none active:cursor-grabbing",
        isDragging
