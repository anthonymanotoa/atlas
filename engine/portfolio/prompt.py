...
3. ABOUT: 3–4 frases humanas y concretas — ecuatoriano basado en Buenos Aires, 100% remoto,
   bilingüe, ex-cofundador de una fintech (Kebo), hoy en retención + experimentación + GenAI en
   e-commerce. Nombra empresas reales (Trafilea, Platzi) como prueba social. Incluye foto.
