...
PEER_EXAMPLES: list[dict] = [
    ...
    },
    {
        ...
        "what_to_steal": [
            ...
            "Nombrar empresas y métricas reales (Trafilea, Platzi, el 0→40k) como prueba social",
    ...
    },
    {
        ...
        "what_to_steal": [
            ...
            "Un 'Sobre mí' humano (ecuatoriano en Buenos Aires, remoto, bilingüe, ex-founder fintech)",
